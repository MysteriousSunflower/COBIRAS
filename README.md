...
- cd to `prepare-video-files/` and execute the `prepare_video_files.sh` script:
  ...
  runs, simulating continous quality levels. The representations will be dashed and moved to folders
  in the `DASH-setup` directory. You can gather detailed ffmpeg encoding settings from
